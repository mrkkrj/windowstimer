...
/**
@brief Basic simple timer implementation using only native Windows API.
...
Implementation uses C++89 standard for portability. Use it on Windows if you
don't have/want Qt or Boost in your project.
